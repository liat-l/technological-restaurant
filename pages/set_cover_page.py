...
כל רובוט מייצג אזור שירות אפשרי וכל שולחן מייצג דרישת כיסוי

האלגוריתם בוחר בכל איטרציה את הרובוט המכסה את מספר השולחנות הלא מכוסים הגדול ביותר

מטרת האלגוריתם היא למצוא את מספר הרובוטים המינימלי הנדרש לכיסוי מלא של כל שולחנות המסעדה
""")
st.divider()
...
uploaded_excel = st.file_uploader(
    "📊 העלו את קובץ האקסל המכיל את פוטנציאל אזורי השירות והרובוטים שלך", 
    type=["xlsx"]
)
...
if uploaded_excel is not None:
    ...
    👋 **?מוכנים להתחיל באופטימיזציה**
     ...
     אנא העלו את קובץ האקסל
    המכיל את רשימת אזורי השירות והשולחנות הפוטנציאליים
