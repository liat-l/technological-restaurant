...
st.markdown("""
<p dir="rtl">
ברוכים הבאים למודול <b>Robo-Coverage</b><br><br>

אלגוריתם זה מנתח את מבנה המסעדה, חלוקת האזורים והדרישות שלכם.<br><br>

המערכת מחשבת באופן מתמטי את כמות המינימום של הרובוטים הנדרשים כדי להבטיח כיסוי שירות מלא לכל השולחנות.<br><br>
