...
def greedy_set_cover(universe, sets):
    ...
    while uncovered:
        ...
        max_new_elements = -1
        best_set_total_size = -1  # משתנה חדש לעזרה בפתרון תיקו
        ...
        for name, elements in sets.items():
            ...
            total_size = len(elements)  # הגודל המקורי של הקבוצה

            # 1. אם מצאנו קבוצה שמכסה יותר שולחנות חדשים - בוחרים בה
            ...
            # 2. פתרון תיקו: אם הכמות שווה, בוחרים בקבוצה המורחבת/גדולה יותר (כמו S8 או S3)
